...
class docling2parquetTransform(BaseTool):
    """Tool that apples docling2parquet transform."""

    name: str = "docling2parquet"
    args_schema: Type[BaseModel] = docling2parquetInput
    description: str = "Apply docling2parquet transform on files in input folder"
