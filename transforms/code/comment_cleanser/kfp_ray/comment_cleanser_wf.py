...
def compute_exec_params_func(
    ...
    comment_cleanser_contents_column_name: str,
    comment_cleanser_document_id_column_name: str,
    comment_cleanser_n_processes: int,
    comment_cleanser_tmp_dir: str,
    comment_cleanser_timeout: int,
    comment_cleanser_skip_timeout: bool,
) -> dict:
    ...
    return {
        ...
        "comment_cleanser_contents_column_name": comment_cleanser_contents_column_name,
        "comment_cleanser_document_id_column_name": comment_cleanser_document_id_column_name,
        "comment_cleanser_n_processes": comment_cleanser_n_processes,
        "comment_cleanser_tmp_dir": comment_cleanser_tmp_dir,
        "comment_cleanser_timeout": comment_cleanser_timeout,
        "comment_cleanser_skip_timeout": comment_cleanser_skip_timeout,
    }
...
TASK_NAME: str = "comment_cleanser"


# Pipeline to invoke execution on remote resource
@dsl.pipeline(
    name=TASK_NAME + "-ray-pipeline",
    description="Pipeline for comment cleaning task",
)
def comment_cleanser(
    # Ray cluster
    ray_name: str = "comment_cleanser-kfp-ray",  # name of Ray cluster
    ...
    # data access
    data_s3_config: str = "{'input_folder': 'test/comment_cleanser/input/', 'output_folder': 'test/comment_cleanser/output/'}",
    ...
    comment_cleanser_contents_column_name: str = "contents",
    comment_cleanser_document_id_column_name: str = "document_id",
    comment_cleanser_n_processes: int = 5,
    comment_cleanser_tmp_dir: str = "",
    comment_cleanser_timeout: int = 300,
    comment_cleanser_skip_timeout: bool = False,
    ...
    """
    Pipeline to execute Comment Cleanser transform
...
if __name__ == "__main__":
    ...
    compiler.Compiler().compile(comment_cleanser, __file__.replace(".py", ".yaml"))
