...
from comment_cleanser_transform_ray import CommentCleanserRayTransformConfiguration
...
if __name__ == "__main__":
    ...
    sys.argv = ParamsUtils.dict_to_req(launcher_params | comment_cleanser_params)
