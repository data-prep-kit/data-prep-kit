...
def gneissweb_classification_run1(
    # Ray cluster
    ...
    # data access
    data_s3_config: str = "{'input_folder': 'gneissweb-demo-single/rep_removal_output/', 'output_folder': 'gneissweb-demo-single/gneissweb_classification_output1/'}",
...
if __name__ == "__main__":
    ...
    compiler.Compiler().compile(gneissweb_classification_run1, __file__.replace(".py", ".yaml"))
