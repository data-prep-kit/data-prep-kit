...
def gneissweb_classification_run3(
    # Ray cluster
    ...
    # data access
    data_s3_config: str = "{'input_folder': 'gneissweb-demo-single/gneissweb_classification_output2/', 'output_folder': 'gneissweb-demo-single/gneissweb_classification_output3/'}",
    ...
    gcls_model_url: str = "ibm-granite/GneissWeb.Med_classifier",
    gcls_model_file_name: str = "fasttext_medical.bin",
    gcls_content_column_name: str = "text",
    gcls_output_label_column_name: str = "medical_label",
    gcls_output_score_column_name: str = "medical_score",
...
if __name__ == "__main__":
    ...
    compiler.Compiler().compile(gneissweb_classification_run3, __file__.replace(".py", ".yaml"))
