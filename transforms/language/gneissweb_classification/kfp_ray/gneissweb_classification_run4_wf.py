...
def gneissweb_classification_run4(
    # Ray cluster
    ...
    # data access
    data_s3_config: str = "{'input_folder': 'gneissweb-demo-single/gneissweb_classification_output3/', 'output_folder': 'gneissweb-demo-single/gneissweb_classification_output4/'}",
    ...
    gcls_model_url: str = "ibm-granite/GneissWeb.Edu_classifier",
    gcls_model_file_name: str = "fasttext_education.bin",
    gcls_content_column_name: str = "text",
    gcls_output_label_column_name: str = "education_label",
    gcls_output_score_column_name: str = "education_score",
...
if __name__ == "__main__":
    ...
    compiler.Compiler().compile(gneissweb_classification_run4, __file__.replace(".py", ".yaml"))
