...
def gneissweb_classification_run5(
    # Ray cluster
    ...
    # data access
    data_s3_config: str = "{'input_folder': 'gneissweb-demo-single/gneissweb_classification_output4/', 'output_folder': 'gneissweb-demo-single/gneissweb_classification_output5/'}",
    ...
    gcls_model_url: str = "ibm-granite/GneissWeb.Tech_classifier",
    gcls_model_file_name: str = "fasttext_technology_computing.bin",
    gcls_content_column_name: str = "text",
    gcls_output_label_column_name: str = "technology_computing_label",
    gcls_output_score_column_name: str = "technology_computing_score",
...
if __name__ == "__main__":
    ...
    compiler.Compiler().compile(gneissweb_classification_run5, __file__.replace(".py", ".yaml"))
