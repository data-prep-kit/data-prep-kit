...
def gneissweb_classification_run6(
    # Ray cluster
    ...
    # data access
    data_s3_config: str = "{'input_folder': 'gneissweb-demo-single/gneissweb_classification_output5/', 'output_folder': 'gneissweb-demo-single/gneissweb_classification_output6/'}",
    ...
    gcls_model_url: str = "ibm-granite/GneissWeb.Sci_classifier",
    gcls_model_file_name: str = "fasttext_science.bin",
    gcls_content_column_name: str = "text",
    gcls_output_label_column_name: str = "science_label",
    gcls_output_score_column_name: str = "science_score",
...
if __name__ == "__main__":
    ...
    compiler.Compiler().compile(gneissweb_classification_run6, __file__.replace(".py", ".yaml"))
