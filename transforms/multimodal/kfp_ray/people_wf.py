...
def compute_exec_params_func(
    ...
    return {
        ...
        "people_batch_size": people_batch_size,
    }
...
@dsl.pipeline(
    ...
    description="Pipeline for people multimodal prototype transform",
)
def people(
    # Ray cluster
    ray_name: str = "people-kfp-ray",
    ...
    people_mode: str = "blur",
    people_threshold: float = 0.6,
    people_batch_size: int = 50,
    # additional parameters
    additional_params: str = '{"wait_interval": 2, "wait_cluster_ready_tmout": 400, "wait_cluster_up_tmout": 300, "wait_job_ready_tmout": 400, "wait_print_tmout": 30, "http_retries": 5}',
):
    """
    Pipeline to execute people transform
    ...
    :param people_mode - #
    :param people_threshold - #
    :param people_batch_size - #
    :return: None
    """
...
if __name__ == "__main__":
    ...
    compiler.Compiler().compile(people, __file__.replace(".py", ".yaml"))
