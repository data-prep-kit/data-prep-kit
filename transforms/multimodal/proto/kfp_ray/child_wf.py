...
EXEC_SCRIPT_NAME: str = "child_transform_ray.py"
...
def compute_exec_params_func(
    ...
    child_child_prompts: str,
    child_nsfw_prompts: str,
    ...
    return {
        ...
        "child_child_prompts": child_child_prompts,
        "child_nsfw_prompts": child_nsfw_prompts,
    }
...
@dsl.pipeline(
    ...
    description="Pipeline for child multimodal prototype transform",
)
def child(
    # Ray cluster
    ray_name: str = "child-kfp-ray",
    ...
    # child parameters
    child_child_prompts : str = "['a photo of a young boy', 'a photo of a young girl', 'a photo of a child', 'a photo of a kid', 'a photo of a baby', 'a photo of a teenager', 'a photo of a toddler']",

    child_nsfw_prompts : str = "[ 'violent scene', 'nudity', 'a pornographic scene']",
    # additional parameters
    additional_params: str = '{"wait_interval": 2, "wait_cluster_ready_tmout": 400, "wait_cluster_up_tmout": 300, "wait_job_ready_tmout": 400, "wait_print_tmout": 30, "http_retries": 5}',
):
    """
    Pipeline to execute child transform
...
if __name__ == "__main__":
    ...
    compiler.Compiler().compile(child, __file__.replace(".py", ".yaml"))
