...
EXEC_SCRIPT_NAME: str = "iocr_transform_ray.py"
...
def compute_exec_params_func(
    ...
    return {
        ...
        "iocr_model_path": iocr_model_path,
    }
...
@dsl.pipeline(
    ...
    description="Pipeline for iocr multimodal prototype transform",
)
def iocr(
    # Ray cluster
    ray_name: str = "iocr-kfp-ray",
    ...
    # data access
    data_s3_config: str = "{'input_folder': 'test-data/iocr/input/', 'output_folder': 'test-data/iocr/output/'}",
    ...
    # nsiocrfw parameters
    iocr_model_path: str = "models/ocr_iocr/artifacts",
    # additional parameters
    additional_params: str = '{"wait_interval": 2, "wait_cluster_ready_tmout": 400, "wait_cluster_up_tmout": 300, "wait_job_ready_tmout": 400, "wait_print_tmout": 30, "http_retries": 5}',
):
    """
    Pipeline to execute iocr transform
    ...
    :param iocr_model_path - # The path to the iocr model to load
    :return: None
    """
...
if __name__ == "__main__":
    ...
    compiler.Compiler().compile(iocr, __file__.replace(".py", ".yaml"))
