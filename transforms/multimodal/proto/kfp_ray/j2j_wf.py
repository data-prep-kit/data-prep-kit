...
EXEC_SCRIPT_NAME: str = "j2j_transform_ray.py"
...
def compute_exec_params_func(
    ...
    return {
        ...
        "j2j_datapoints_per_file": j2j_datapoints_per_file,
    }
...
@dsl.pipeline(
    ...
    description="Pipeline for j2j multimodal prototype transform",
)
def j2j(
    # Ray cluster
    ray_name: str = "j2j-kfp-ray",
    ...
    # j2j parameters
    j2j_datapoints_per_file: int =  1000, # 200mb
    # additional parameters
    additional_params: str = '{"wait_interval": 2, "wait_cluster_ready_tmout": 400, "wait_cluster_up_tmout": 300, "wait_job_ready_tmout": 400, "wait_print_tmout": 30, "http_retries": 5}',
):
    """
    Pipeline to execute j2j transform
...
if __name__ == "__main__":
    ...
    compiler.Compiler().compile(j2j, __file__.replace(".py", ".yaml"))
