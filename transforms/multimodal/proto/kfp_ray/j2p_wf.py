...
EXEC_SCRIPT_NAME: str = "j2p_transform_ray.py"
...
def compute_exec_params_func(
    ...
    j2p_image_path_prefix: str,
    j2p_image_path_prefix_alias: str,
    j2p_parquet_size_limit: int,
    j2p_secondary_data_access_config: dict
) -> dict:
    ...
    return {
        ...
        "j2p_image_path_prefix": j2p_image_path_prefix,
        "j2p_image_path_prefix_alias": j2p_image_path_prefix_alias,
        "j2p_parquet_size_limit": j2p_parquet_size_limit,
        "j2p_secondary_data_access_config": str(j2p_secondary_data_access_config)
    }
...
@dsl.pipeline(
    ...
    description="Pipeline for j2p multimodal prototype transform",
)
def j2p(
    # Ray cluster
    ray_name: str = "j2p-kfp-ray",
    ...
    # data access
    data_s3_config: str = "{'input_folder': 'test-data/faces/input/', 'output_folder': 'test-data/faces/output/'}",
    data_s3_access_secret: str = "s3-secret",
    data_max_files: int = -1,
    data_num_samples: int = -1,
    data_checkpointing: bool = "False",
    data_files_to_use: str = "['.json']",
    # orchestrator
    ...
    j2p_image_path_prefix: str = "",
    j2p_image_path_prefix_alias: str = "",
    j2p_parquet_size_limit: int =  1024*1024*200, # 200mb
    j2p_secondary_data_access_config: dict = { } ,
    # additional parameters
    additional_params: str = '{"wait_interval": 2, "wait_cluster_ready_tmout": 400, "wait_cluster_up_tmout": 300, "wait_job_ready_tmout": 400, "wait_print_tmout": 30, "http_retries": 5}',
):
    """
    Pipeline to execute j2p transform
    ...
    # :param people_model_path - # The path to the people model to load
    :return: None
    """
    ...
    with dsl.ExitHandler(clean_up_task):
        ...
        compute_exec_params = compute_exec_params_op(
            ...
            j2p_image_path_prefix_alias=j2p_image_path_prefix_alias,
            j2p_parquet_size_limit=j2p_parquet_size_limit,
            j2p_secondary_data_access_config=j2p_secondary_data_access_config
        )
...
if __name__ == "__main__":
    ...
    compiler.Compiler().compile(j2p, __file__.replace(".py", ".yaml"))
