...
EXEC_SCRIPT_NAME: str = "nsfw_transform_ray.py"
...
def compute_exec_params_func(
    ...
    return {
        ...
        "nsfw_model_name": nsfw_model_name,
        "nsfw_normal_class": nsfw_normal_class,
        "nsfw_nsfw_class": nsfw_nsfw_class,
...
@dsl.pipeline(
    ...
    description="Pipeline for nsfw multimodal prototype transform",
)
def nsfw(
    # Ray cluster
    ray_name: str = "nsfw-kfp-ray",
    ...
    nsfw_normal_class: str = "normal",
    nsfw_nsfw_class: str = "nsfw",
    nsfw_batch_size: int = 32,
    # additional parameters
    additional_params: str = '{"wait_interval": 2, "wait_cluster_ready_tmout": 400, "wait_cluster_up_tmout": 300, "wait_job_ready_tmout": 400, "wait_print_tmout": 30, "http_retries": 5}',
):
    """
    Pipeline to execute nsfw transform
    ...
    :param data_checkpointing -
    :param runtime_actor_options - actor options
    :param runtime_pipeline_id - pipeline id
    :param runtime_code_location - code location
    :param nsfw_model_name - # The model to use from HF
    :param nsfw_normal_class - # The class representing
    :param nsfw_nsfw_class - # The class representing
    :param nsfw_batch_size - #
    :return: None
    """
...
if __name__ == "__main__":
    ...
    compiler.Compiler().compile(nsfw, __file__.replace(".py", ".yaml"))
