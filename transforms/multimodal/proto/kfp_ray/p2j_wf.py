...
EXEC_SCRIPT_NAME: str = "p2j_transform_ray.py"
...
def compute_exec_params_func(
    ...
    p2j_export_columns: str,
    p2j_as_jsonl: bool,
    p2j_write_images: bool,
    p2j_write_image_path: str,
) -> dict:
    ...
    return {
        ...
        "p2j_export_columns": p2j_export_columns,
        "p2j_as_jsonl": p2j_as_jsonl,
        "p2j_write_images": p2j_write_images,
        "p2j_write_image_path": p2j_write_image_path,
    }
...
@dsl.pipeline(
    ...
    description="Pipeline for p2j multimodal prototype transform",
)
def p2j(
    # Ray cluster
    ray_name: str = "p2j-kfp-ray",
    ...
    # p2j parameters
    #people_model_path: str = "models/yolov8m-seg.pt",
    p2j_export_columns: str =  "['id', 'orig_image_fpaths', 'conversations', 'fixed_image_fpaths', 'source', 'blurred_images']",
    p2j_as_jsonl: bool = True,
    p2j_write_images: bool = False,
    p2j_write_image_path: str = "",
    # additional parameters
    additional_params: str = '{"wait_interval": 2, "wait_cluster_ready_tmout": 400, "wait_cluster_up_tmout": 300, "wait_job_ready_tmout": 400, "wait_print_tmout": 30, "http_retries": 5}',
):
    """
    Pipeline to execute p2j transform
...
if __name__ == "__main__":
    ...
    compiler.Compiler().compile(p2j, __file__.replace(".py", ".yaml"))
