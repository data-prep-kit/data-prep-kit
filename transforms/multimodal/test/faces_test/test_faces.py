...
from dpk_mm.faces.transform import FacesTransform
...
class TestProtoTransform(AbstractTableTransformTest):
    ...
    def get_test_transform_fixtures(self) -> list[tuple]:
        ...
        expected_dir = os.path.join(test_data_dir, "faces/expected")
        ...
        fixtures = [
            (FacesTransform(config), input_tables, expected_tables, expected_metadata_list),
        ]
        return fixtures
