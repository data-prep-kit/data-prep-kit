...
* _blocklist_source_url_column_name_ - specifies the name of the table column holding the URL from which the 
...
## Running
You can run the [local.py](blocklist_local_ray.py) to
transform the `test1.parquet` file in [test input data](test-data/input). The simple example reports blocked domains
found in the input parquet file. 
<pre>
% make venv
% source venv/bin/activate
(venv) % cd src
(venv) % python blocklist_local.py
10:16:02 INFO - Reading domain list from ../test-data/domains 
10:16:02 INFO - Added 27 domains to domain list
10:16:02 INFO - Loading trie with 27 items.
input table: pyarrow.Table
title: string
----
title: [["https://poker","https://poker.fr","https://poker.foo.bar","https://abc.efg.com","http://asdf.qwer.com/welcome.htm","http://aasdf.qwer.com/welcome.htm","https://zxcv.xxx/index.asp"]]
...
----
title: [["https://poker","https://poker.fr","https://poker.foo.bar","https://abc.efg.com","http://asdf.qwer.com/welcome.htm","http://aasdf.qwer.com/welcome.htm","https://zxcv.xxx/index.asp"]]
blocklisted: [["poker","poker.fr","poker.foo.bar","","","",""]]]
output metadata : {'total_docs_count': 7, 'block_listed_docs_count': 3}
(venv) % deactivate
%
</pre>
