...
## Summary 
The openserach transform creates and inserts data into an [OpenSearch vector index](https://docs.opensearch.org/latest/vector-search/creating-vector-index/). 
