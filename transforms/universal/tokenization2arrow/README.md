...
<p align="Left"> Note: In case the tokenizer is not available for download without authentication, users should login to their Hugging Face accounts, and if prompted, they need to accept the terms & conditions (it is one time activity).
